"""
AI-Enabled Smart Traffic Light Signal — Streamlit App
======================================================
...
⬡ &nbsp; AI-ENABLED SMART TRAFFIC LIGHT SIGNAL &nbsp; ⬡ &nbsp; REAL-TIME SIGNAL OPTIMIZATION
</div>
""", unsafe_allow_html=True)
...
with st.expander("📡 HOW IT WORKS", expanded=False):
    st.markdown("""
    <div style="font-family:'Courier New',monospace;font-size:0.72rem;color:rgba(200,230,255,0.75);line-height:2.1;padding:6px 2px;">

    <span style="color:#00e5ff;">📷</span> &nbsp; Traffic cameras capture real-time video at intersections.<br><br>
    <span style="color:#00e5ff;">🔍</span> &nbsp; Computer vision techniques are applied for vehicle detection and lane-wise counting.<br><br>
    <span style="color:#00e5ff;">🤖</span> &nbsp; Machine learning models analyze traffic density and predict optimal green signal duration.<br><br>
    <span style="color:#00e5ff;">🚨</span> &nbsp; Emergency vehicles are identified using visual cues or priority signaling.<br><br>
    <span style="color:#00e5ff;">⚡</span> &nbsp; The traffic signal controller dynamically updates signal phases in real time.
